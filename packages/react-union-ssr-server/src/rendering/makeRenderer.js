...
const hoistComponentStatics = require('./hoistComponentStatics');
const resolveInitialProps = require('./resolveInitialProps');

const makeRenderer = applicationHandler => {
	// TODO: Add `options` as the second parameter.

	return async (originalHTML, clientStats, httpContext) => {
